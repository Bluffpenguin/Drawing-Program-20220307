...
PFont font;
boolean shapesOverlay=false, strokeOverlay=false, colourOverlay=false, backgroundOverlay=false, lineDraw=false, circleDraw=true, squareDraw=false, triangleDraw=false;
