...
PFont font, fontB;
boolean shapesOverlay=false, strokeOverlay=false, colourOverlay=false, backgroundOverlay=false, templateOverlay=true, lineDraw=true, circleDraw=false, squareDraw=false, triangleDraw=false;
