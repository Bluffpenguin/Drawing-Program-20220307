...
PFont font, fontB;
boolean shapesOverlay=false, strokeOverlay=false, colourOverlay=false, backgroundOverlay=false, templateOverlay=false, lineDraw=true, circleDraw=false, squareDraw=false, triangleDraw=false;
